...
public class OrderMapperTest {
    ...
    @Test
    public void setCustomerNullIfCustomerUnregistered() throws Exception {
    ...
    @Test
    public void mapOrderToOrderDto() throws Exception {
    ...
    @Test
    public void mapOrderDtoToOrder() throws Exception {
        orderDto.setCustomer(2L);
        Order result = mapper.mapOrderDtoToOrder(orderDto);
